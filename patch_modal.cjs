...
const replacement = `{/* Dynamic Bulk Action Bar for Pending Biomarkers */}
              {toApproveKeys.length > 0 && (
                <div className="flex items-center gap-2 mb-4 p-3 bg-indigo-950/40 border border-indigo-800/50 rounded-xl flex-wrap">
                  ...
                  <div className="flex items-center gap-1.5 ml-auto flex-wrap">
                    <button
                      ...
                      className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-xs font-medium transition-colors shadow-sm cursor-pointer whitespace-nowrap"
                    >
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 rounded-lg text-xs font-medium transition-colors cursor-pointer whitespace-nowrap"
                    >
